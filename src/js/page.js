 ...
 * (c) 2015
 *
 * Part of the wpGitter application, a simple page framework.
 *
 * @author RainbowDashDC <rainbowdashdc@mezgrman.de> (Jared Allard)
 * @version 0.1.0
 * @license MIT
 *
 * This JS file uses JSDoc for documentation generation.
 * TODO: Make framework a bit better; i.e not hardcoding.
 */
...
Page.prototype.set = function (_page) {
  ...
  // show back
  if (this.pages[_page].back === false) {
    $("#logo").show();
    $("#back").hide();
  } else {
    $("#logo").hide();
